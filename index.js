...
const addStudent = () => inquirer
    ...
    console.log(chalk.italic.bold.blueBright("\t \t \t Student added successfully!"));
    promptUser();
});
// Display all students
const displayStudents = () => {
    console.log(chalk.italic.magenta("List of students:"));
    students.forEach((student) => console.log(chalk.yellowBright(`Name: ${student.name}, ID: ${student.id}, Grade: ${student.grade}, address: ${student.address}, contactNumber: 
...
console.log(chalk.italic.bold.magenta("\t \t \t Welcome to Student Management Project! "));
promptUser();
